 ...
 */const r="ION-CONTENT",s="ion-content",a=".ion-content-scroll-host",c=`${s}, ${a}`,i=o=>o&&o.tagName===r,l=async o=>i(o)?(await new Promise((t=>(0,n.c)(o,t))),o.getScrollElement()):o,u=o=>o.closest(c),h=(o,t)=>{if(i(o)){const e=o;return e.scrollToTop(t)}return Promise.resolve(o.scrollTo({top:0,left:0,behavior:t>0?"smooth":"auto"}))},m=(o,t,e,n)=>{if(i(o)){const r=o;return r.scrollByPoint(t,e,n)}return Promise.resolve(o.scrollBy({top:e,left:t,behavior:n>0?"smooth":"auto"}))}},6078:(o,t,e)=>{e.r(t),e.d(t,{startStatusTap:()=>a});var n=e(65),r=e(8487),s=e(6587);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
//# sourceMappingURL=78.f41e49c4.js.map